...
M.open = function ()
  ...
  vim.api.nvim_set_keymap('n', '<CR>', '<cmd>lua require"pandoc.toc".handler_keypress()<CR>', { noremap = true, silent = true, nowait = true })
  vim.api.nvim_set_keymap('n', config.get().toc.close or 'q', '<cmd>lua require"pandoc.toc".close()<CR>', { noremap = true, silent = true, nowait = true })
end
